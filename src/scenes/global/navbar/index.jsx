  ...
  return (
    <>
      <div className="flex nav">
        ...
        >
          <g transform="matrix(1,0,0,1,-0.6060575385022275,0.09858344588765533)">
            <svg
              viewBox="0 0 396 84"
            ...
            >
              <g
                id="tight-bounds"
                transform="matrix(1,0,0,1,0.23999878524688256,-0.039060052219326735)"
              >
                <svg
                  viewBox="0 0 395.52 84.07812010443864"
                  height="84.07812010443864"
                  width="395.52"
                >
                  <g>
                    <svg
        ...
        {!isSmallScreen ? (
          ...
          <div className="hamburger">
            <IconButton onClick={toggleMenu} sx={{ padding: "0" }}>
              <Hamburger toggled={menu} size={20} />
            </IconButton>
          </div>
        )}
      </div>
      {menu && (
        <div className={`mobile-nav ${menu ? "open" : "closed"}`}>
          <ul className="flex column flexMiddle">
            <li>
